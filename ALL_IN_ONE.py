...
if __name__ == "__main__":
    ...
    Initial_Connection("4800a67ceff340d2ab4f79406a01f58e5a97d589b29b35394b2a82a299b19745")

    if not Exeception_length(r"C:\Users\cherif\Documents\top secret\behaviour detections\behaviour_summary_results.json"):
        if not Exception_Verdicts(r"C:\Users\cherif\Documents\top secret\behaviour detections\behaviour_summary_results.json"):
            
            ALL_DATA_HERE["Lockbit"] = check_for_lockbit_behaviors(r"C:\Users\cherif\Documents\top secret\behaviour detections\behaviour_summary_results.json")
            ALL_DATA_HERE["Wannacry"] = check_for_wannacry_behaviors(r"C:\Users\cherif\Documents\top secret\behaviour detections\behaviour_summary_results.json")
            ALL_DATA_HERE["Conti"] = check_for_conti_behaviors(r"C:\Users\cherif\Documents\top secret\behaviour detections\behaviour_summary_results.json")
            ALL_DATA_HERE["Maze"] = check_for_maze_behaviors(r"C:\Users\cherif\Documents\top secret\behaviour detections\behaviour_summary_results.json")
            ALL_DATA_HERE["Revil/Sodinokibi"] = check_for_revil_Sodinokibi_behaviors(r"C:\Users\cherif\Documents\top secret\behaviour detections\behaviour_summary_results.json")
            ALL_DATA_HERE["Locky"] = check_for_locky_behaviors(r"C:\Users\cherif\Documents\top secret\behaviour detections\behaviour_summary_results.json")
            ALL_DATA_HERE["Petya/NotPetya"] = check_for_petya_behaviors(r"C:\Users\cherif\Documents\top secret\behaviour detections\behaviour_summary_results.json")
            ALL_DATA_HERE["TeslaCrypt"] = check_for_TeslaCrypt_behaviors(r"C:\Users\cherif\Documents\top secret\behaviour detections\behaviour_summary_results.json")
            ALL_DATA_HERE["ALPHV"] = check_for_ALPHV_behaviors(r"C:\Users\cherif\Documents\top secret\behaviour detections\behaviour_summary_results.json")
            ALL_DATA_HERE["BlackCat"] = check_for_BlackCat_behaviors(r"C:\Users\cherif\Documents\top secret\behaviour detections\behaviour_summary_results.json")
            ALL_DATA_HERE["BlackMatter"] = check_for_BlackMatter_behaviors(r"C:\Users\cherif\Documents\top secret\behaviour detections\behaviour_summary_results.json")
            print(ALL_DATA_HERE)
            max = ""
            cpt = 0
